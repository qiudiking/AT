...
class MysqlContainer implements \SplSubject {
	 ...
	 * 获取数据，并填充到实体对象中
	 *
	 * @param \server\DB\Mongodb\MongodbEntity|null $entity
	 *
	 * @return bool
	 */
	...
	/**
	 * @param \server\DB\MysqlEntity $mysqlEntity
	 *
	 * @throws \server\Exception\DBException
	 */
	 ...
	 * @param \server\DB\MysqlEntity $mysqlEntity
	 *
	 * @return null|\server\DB\MysqlContainer
	 * @throws \server\Exception\DBException
	 */
